...
public class NeuralNetwork
{
    ...
    public float logistic(float x)//Logistic
    {
    ...
    public float logisticDer(float x)//Производная Leaky ReLu
    {
    ...
    public static float Norm(float t)
    {
        return (t-1) / 7;
    }

    public static float Norm2(float t)
    {
        return (t - 9) / 7;
    }
